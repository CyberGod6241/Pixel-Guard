  ...
  return (
    <section id="about" className="relative py-24 px-6" style={{ background: "#060c1a" }}>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-center text-sm leading-relaxed max-w-2xl mx-auto mb-12" style={{ color: "#7a9ab8" }}>
          PixelGuard is a final year Computer Science project developed by five undergraduate students.
          Our mission is to make image steganography accessible, secure, and easy to use — hiding
          sensitive communications inside ordinary images with zero perceptible difference.
        </p>
